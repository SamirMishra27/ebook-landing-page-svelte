	...
	<div class="hero-text white text-center">
		...
		{:else}
			...
			<p class="light-gray mb-l">
				...
				an apartment. That’s why I wrote this book – to tell you how I did it. No bullshit, no
				stress.
			</p>
			<Button>Purchase E-book for ₹899</Button>
		{/if}
	</div>
</section>
...
<style>
	...
	.hero-showcase {
		...
		background: linear-gradient(135deg, #e2cbff, #e2cbff 25%, #e2cbff 50%, #e2cbff 75%, #927bce);
	}
